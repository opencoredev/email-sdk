    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Email SDK supports adapters for Resend, SMTP, Postmark, SendGrid, Mailgun, Cloudflare Email Sending, AWS SES, MailerSend, Brevo, Mailchimp Transactional, SparkPost, Loops, Sequenzy, Plunk, Mailtrap, Scaleway, ZeptoMail, and MailPace.",
          },
        },
        {
          "@type": "Question",
