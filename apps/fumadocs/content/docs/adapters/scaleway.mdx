...
```bash
SCALEWAY_SECRET_KEY="..." SCALEWAY_PROJECT_ID="..." npm exec --package=@opencoredev/email-sdk -- email-sdk doctor --adapter scaleway
```

```bash
SCALEWAY_SECRET_KEY="..." SCALEWAY_PROJECT_ID="..." npm exec --package=@opencoredev/email-sdk -- email-sdk send \
  --adapter scaleway \
  --region fr-par \
