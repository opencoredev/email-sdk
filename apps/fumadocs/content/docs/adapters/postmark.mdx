...
```bash
POSTMARK_SERVER_TOKEN="..." npm exec --package=@opencoredev/email-sdk -- email-sdk doctor --adapter postmark
```

```bash
POSTMARK_SERVER_TOKEN="..." npm exec --package=@opencoredev/email-sdk -- email-sdk send \
  --adapter postmark \
