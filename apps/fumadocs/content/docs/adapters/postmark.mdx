...
```bash
POSTMARK_SERVER_TOKEN="..." npx --package @opencoredev/email-sdk email-sdk doctor --adapter postmark
```

```bash
POSTMARK_SERVER_TOKEN="..." npx --package @opencoredev/email-sdk email-sdk send \
  --adapter postmark \
