...
Support is source-derived, not proof of a live send or delivery. Review [Verification evidence](/docs/adapters/verification) for configured tests, available authentication probes, and any dated public results across all 24 adapters.
