...
```bash
SPARKPOST_API_KEY="..." npm exec --package=@opencoredev/email-sdk -- email-sdk doctor --adapter sparkpost
```

```bash
SPARKPOST_API_KEY="..." npm exec --package=@opencoredev/email-sdk -- email-sdk send \
  --adapter sparkpost \
