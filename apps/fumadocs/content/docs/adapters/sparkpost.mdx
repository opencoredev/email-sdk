...
```bash
SPARKPOST_API_KEY="..." npx --package @opencoredev/email-sdk email-sdk doctor --adapter sparkpost
```

```bash
SPARKPOST_API_KEY="..." npx --package @opencoredev/email-sdk email-sdk send \
  --adapter sparkpost \
