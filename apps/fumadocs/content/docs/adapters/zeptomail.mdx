...
```bash
ZEPTOMAIL_TOKEN="..." npm exec --package=@opencoredev/email-sdk -- email-sdk doctor --adapter zeptomail
```

```bash
ZEPTOMAIL_TOKEN="..." npm exec --package=@opencoredev/email-sdk -- email-sdk send \
  --adapter zeptomail \
