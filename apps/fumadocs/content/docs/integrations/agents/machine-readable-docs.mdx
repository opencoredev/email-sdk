...
The docs site exposes the same active navigation through formats that do not require scraping rendered HTML.
...
<Card title="Coding-agent skill" href="/docs/integrations/agents/skill" description="Install instructions that make agents refresh these sources before coding." />
