...
The skill guides code changes; it is not a runtime email tool. Use the [AI SDK subpath](/docs/integrations/agents/ai-tools) or [MCP server](/docs/integrations/agents/mcp) for runtime agent calls.

<Card title="Machine-readable docs" href="/docs/integrations/agents/machine-readable-docs" description="Give agents raw Markdown and full documentation indexes." />
