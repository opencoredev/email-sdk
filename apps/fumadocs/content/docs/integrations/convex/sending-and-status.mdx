...
| `providerMessageId` | The provider receipt used to correlate webhook events or reconcile a terminal partial send. |
| `providerFailure` | Normalized terminal failure details, including retryability, delivery certainty, and recipient counts when available. |
