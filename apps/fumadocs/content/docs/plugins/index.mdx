...
| ----------------- | -------------------------------------------------------------------- |
| Shared defaults   | Use the [defaults plugin](/docs/plugins/defaults).                   |
| Redacted logging  | Use the [observability plugin](/docs/plugins/observability).         |
| Test capture      | Use the [capture plugin](/docs/plugins/capture).                     |
| Custom provider   | Follow [Create an adapter](/docs/guides/create-adapter).             |
| Reusable behavior | Follow [Create your first plugin](/docs/guides/create-first-plugin). |
