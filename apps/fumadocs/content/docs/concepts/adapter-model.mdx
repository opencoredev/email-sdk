...
Use <a href="/docs/concepts/fallbacks-and-retries">Fallbacks and retries</a> to understand route order. Use <a href="/docs/adapters/field-support">Field support</a> before choosing backup routes.
