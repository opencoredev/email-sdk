...
Email SDK is server-side and supports Node.js 20+ or Bun 1.1+. Use ESM imports on any supported runtime, or `require()` from CommonJS applications on Node.js 20.19+. Keep API keys and SMTP credentials out of browser bundles.
