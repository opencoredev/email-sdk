---
title: Email SDK
description: TypeScript email SDK documentation for production transactional send pipelines across Resend, SMTP, Postmark, SendGrid, Mailgun, AWS SES, and more.
icon: Mail
---
