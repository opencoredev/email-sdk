---
title: Email SDK
description: Email for TypeScript apps. Send transactional email through 27 adapters with one typed SDK.
---
...
- 26 provider API adapters plus SMTP, 27 adapters total
