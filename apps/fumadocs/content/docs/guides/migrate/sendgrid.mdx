...
```bash
SENDGRID_API_KEY=SG.x npx --package @opencoredev/email-sdk email-sdk doctor --adapter sendgrid
SENDGRID_API_KEY=SG.x npx --package @opencoredev/email-sdk email-sdk send \
  --adapter sendgrid \
