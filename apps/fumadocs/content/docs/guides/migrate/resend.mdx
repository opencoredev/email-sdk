...
```bash
RESEND_API_KEY=re_xxx npm exec --package=@opencoredev/email-sdk -- email-sdk doctor --adapter resend
RESEND_API_KEY=re_xxx npm exec --package=@opencoredev/email-sdk -- email-sdk send \
  --adapter resend \
