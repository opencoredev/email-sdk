...
description: Install dynamic Email SDK guidance for AI agents that integrate, review, or document the package.
---

The repository ships two dynamic skills for Claude Code and other skill-compatible AI agents:
