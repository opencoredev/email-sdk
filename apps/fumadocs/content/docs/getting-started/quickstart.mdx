...
```bash
EMAIL_SDK_TELEMETRY=0 npx --package @opencoredev/email-sdk email-sdk send \
  --adapter resend \
  --from "Acme <hello@acme.com>" \
  --to user@example.com \
  --subject "Welcome" \
...
<Card title="Standalone starter" href="https://github.com/opencoredev/email-sdk/tree/main/packages/email-sdk/examples/first-send" description="A runnable copy of this page for Node 20+ or Bun, with .env loading." />
