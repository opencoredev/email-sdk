...
Return the adapter routing name and normalized receipt fields. `raw` may keep an adapter-specific typed response for application code, but MCP and AI integrations intentionally project it away.
