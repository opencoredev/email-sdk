...
Tags and message metadata are provider-facing fields. Unsupported routes reject them. Send-option metadata is a separate `EmailSendMetadata` object used as lifecycle context.
