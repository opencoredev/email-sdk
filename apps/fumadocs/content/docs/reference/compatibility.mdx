...
Result aliases are non-enumerable getters. Compat warnings print once per deprecated feature only in development, never in production, tests, or MCP stdout.
