...
The current registry contains 26 routes: Resend, Postmark, SendGrid, Cloudflare, Microsoft Graph, Unosend, Iterable, AWS SES, Mailgun, MailerSend, Brevo, Mailchimp Transactional, SparkPost, Loops, Sequenzy, JetEmail, Lettermint, Lettr, Primitive, Plunk, Mailtrap, Scaleway, ZeptoMail, MailPace, SendHeron, and SMTP.
