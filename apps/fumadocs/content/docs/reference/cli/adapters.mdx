...
The current registry contains 27 routes: Resend, Postmark, SendGrid, Cloudflare, Microsoft Graph, Unosend, Iterable, AWS SES, Mailgun, MailerSend, Brevo, Mailchimp Transactional, SparkPost, Loops, Sequenzy, JetEmail, Lettermint, Lettr, Primitive, Plunk, Mailtrap, Scaleway, ZeptoMail, MailPace, SendHeron, Helo, and SMTP.
